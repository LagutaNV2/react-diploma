...
Бэкенд видоизменять нельзя. При необходимости опубликовать сервер в интернете, используйте render.com или аналоги. Опубликованный сервер https://ra16-diploma-1.onrender.com, может работать с перебоями, т.к. используется бесплатный тариф render.com
